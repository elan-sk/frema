...
var GnCarousel = (function () {
  function GnCarousel(element, slickOptions, parent) {
    _classCallCheck(this, GnCarousel);
    ...
    this.children = [].concat(_toConsumableArray(this.element.children));
  ...
  _createClass(GnCarousel, [{
    key: 'watchArrows',
    value: function watchArrows(_ref, _ref2, currentSlide, nextSlide) {
    ...
    key: 'toggleArrows',
    value: function toggleArrows(slideCount, slideIndex) {
      if (slideCount > 1) {
    ...
    key: 'watchAriaAttributes',
    value: function watchAriaAttributes(event, slick, currentSlide) {
      setTimeout(function () {
        [].concat(_toConsumableArray(slick.$slides)).forEach(function (slide, index) {
    ...
    key: 'watchAnimation',
    value: function watchAnimation(event, slick, currentSlide) {
      setTimeout(function () {
        [].concat(_toConsumableArray(slick.$slides)).forEach(function (slide, index) {
          var animatedItem = slide.querySelector('.animate__item');
    ...
    key: 'watchIframes',
    value: function watchIframes(event, slick, currentSlide) {
      var _this = this;

      setTimeout(function () {
        [].concat(_toConsumableArray(slick.$slides)).forEach(function (slide, index) {
          var iframe = slide.querySelector(_this.SELECTORS.iframe);
          var slideWrapper = slide.querySelector(_this.SELECTORS.slide);

          if (iframe) {
            slideWrapper.classList.remove(_this.CLASSES.enablePlayer);
    ...
    value: function initCarousel() {
      ...
      if (this.carouselOptions.autoHideArrows) {
        var _carousel$slick = this.carousel.slick('getSlick');

        var slideCount = _carousel$slick.slideCount;
        var currentSlide = _carousel$slick.currentSlide;
...
var _librariesSlick = __webpack_require__(0);
...
var sliderInstance = [].concat(_toConsumableArray(document.querySelectorAll(SELECTORS.component)));

if (sliderInstance) {
  sliderInstance.forEach(function (slider) {
    var parent = slider.parentElement;
    var slickInstance = new _librariesSlick.GnCarousel(slider, OPTIONS, parent);
...
var sliderInstance = document.querySelector(SELECTORS.component);
...
if (sliderInstance) {
    ...
    var _parent = sliderInstance.parentElement;
    var slickInstance = new _librariesSlick.GnCarousel(sliderInstance, OPTIONS, _parent);
...
if (sliderInstance) {
  var OPTIONS = {
    ...
    customPaging: function customPaging(slider, i) {
      var thumb = $(slider.$slides[i])[0];
      var thumbUrl = thumb.querySelector('.steps__item').dataset.thumb;
